...
export interface PlotConfiguration {
  ...
  /**
   * How this plot came to exist. "auto" = generated by the default-plot pass,
   * "custom" = built by the user in the Composer. Only custom plots are
   * replicated onto a newly added measurement.
   */
  origin?: "auto" | "custom";
  /**
   * Pinned plots stay bound to their own measurement when cycling with
   * Next/Prev; unpinned plots repoint to the newly loaded dataset. Lets
   * the user hold one view still and compare against it while scanning.
   */
  pinned?: boolean;
}
