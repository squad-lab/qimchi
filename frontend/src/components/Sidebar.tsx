      ...
      >
        <PanelGroup direction="vertical" className="h-screen">
          ...
          <button
            ...
            className={
              "text-lg font-semibold bg-cyan-200 p-2 hover:bg-cyan-300 transition-colors w-full text-center" +
              (explorerCollapsed ? "mb-0" : "mb-4")
            }
