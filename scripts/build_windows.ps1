...
# Every path below is relative, so run from the repository root whatever the
# caller's working directory is -- same as build_linux.sh / build_macos.sh,
# which resolve REPO_ROOT from their own location.
...
$stampLines = @(
    "# Generated by build_windows.ps1 -- do not edit.",
