# <img src="./frontend/public/qimchi-logo.png" alt="Qimchi Logo" width="25" style="vertical-align: middle;"/> Qimchi v0.3.2
...
8. **Start the server:**
   ...
   uvicorn main:app --host 127.0.0.1 --port 8001 --workers 8 --log-level info
   ```
...
8. **Start the server:**
   ...
   uvicorn main:app --host 0.0.0.0 --port 8001 --workers 8 --log-level info
   ```
